...
(function () {
  ...
  // BYBIT PROXY CONFIGURATION (HTTP 451 Bypass)
  const BYBIT_BASE_DIRECT = 'https://api.bybit.com/v5';
  ...
  function getBybitUrl(path) {
    if (BYBIT_USE_PROXY) {
      return `${BYBIT_PROXY_URL}/https://api.bybit.com/v5${path}`;
    }
    return `${BYBIT_BASE_DIRECT}${path}`;
  }
